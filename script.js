...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (supportBtn && supportPanel && supportClose) {
    // Open/Close Panel
    ...
    optionButtons.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        const categoryLabel = btn.querySelector('span').textContent;
        
        supportCategoryTitle.textContent = categoryLabel;
        if (supportCategoryHidden) supportCategoryHidden.value = category;
        
        supportOptionsList.style.display = 'none';
    ...
    if (supportBackBtn) {
      supportBackBtn.addEventListener('click', () => {
        supportOptionsList.style.display = 'flex';
